      ...
      <div class="l-grid__item l-grid__item-3 l-grid__item-4-md l-grid__item-12-sm">
        <a class="c-linkWithImage" href="${item.url}" target="${item.target}">
          <div class="c-linkWithImage__image">
            <img src="/fa/id_en/solutions/competencies/dlogger/case/assets/img/img_product_${item.number}.jpg" alt="" decoding="async">
          </div>
...
// JSONファイルのURL
const jsonUrl = '/fa/id_en/solutions/competencies/dlogger/case/assets/data/project.json';
