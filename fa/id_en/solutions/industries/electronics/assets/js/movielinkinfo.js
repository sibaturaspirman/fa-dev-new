...
//蜍慕判繝ｪ繝ｳ繧ｯ
var GET_MOVIE_LINK_INFO = "/id_en/MovieSearchService/GetMovieLinkInfo.do?";
var MOVIE_NO = "movieNO1";
var MOVIE_KISYU_NO = "kisyuNO";
var POPUP_URL = "/id_en/media/html/module_popup.html?"
//---------------------------------------------
				...
				if(errorcode == 0){
					...
					if(dispPattern == "1") {
						...
						if (datas.memberFlg == "9") {
							...
							// chtm.push("<object width=\"480\" height=\"270\" type=\"application/x-shockwave-flash\" data=\"/id_en/shared/lib/mediaelement/flashmediaelement.swf\">");
							// chtm.push("<param name=\"movie\" value=\"/id_en/shared/lib/mediaelement/flashmediaelement.swf\" />");
...
function membersLink(chtm, datas, pattern) {
	...
	sendUrl = hostName + "/id_en/ssl/php/members/b_login.php?moto=" + location.href;
