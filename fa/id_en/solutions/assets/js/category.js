  ...
  var _generateTagList = function(tags) {
    ...
    if(tags.length > 0) {
      tags.forEach(function(value, index) {
        tagElement += `<a href="/fa/id_en/our-stories/index.html?tag[]=${value}" class="c-filter__tag">#${value}</a>`;
      }); 
    }
    return tagElement;    
  }// _generateTagList()
  ...
  .done(function(filter_data, article_data){
    ...
    const _generateArticleCard = function(data) {
      ...
      return `
        ...
        <a class="c-card__link" href="/fa/id_en/our-stories/${data.articleID}/index.html">
