...
if (isDotPage) {
	...
	function tablePicture(src) {
		...
		new_window.document
			.write("<img src=\"/fa/id_en/shared/img/module/bt_close_bunrui.gif\" width=\"58\" height=\"18\" alt=\"Close\" title='Close' />\n");
		new_window.document.write("</div>");
	...
	function subPicture(src, lp2, lp3) {
		...
		new_window.document
			.write("<a href=\"#\" onClick=\"window.close(); return false;\">");
		new_window.document
			.write("<img src=\"/fa/id_en/shared/img/module/btn_close.gif\" width=\"58\" height=\"18\" alt=\"Close\" title='Close' />\n");
		new_window.document.write("</div>");
		new_window.document.write("<" + "/body>");
		new_window.document.write("<" + "/html>");
		new_window.document.close();
	...
	*/
	...
	function tablePicture(src) {
		...
		new_window.document
			.write("<a href=\"#\" onClick=\"window.close(); return false;\">");
		new_window.document
			.write("<img src=\"/fa/id_en/shared/img/module/bt_close_bunrui.gif\" width=\"58\" height=\"18\" alt=\"閉じる\" title='閉じる' />\n");
		new_window.document.write("</div>");
		new_window.document.write("<" + "/body>");
		new_window.document.write("<" + "/html>");
		new_window.document.close();
