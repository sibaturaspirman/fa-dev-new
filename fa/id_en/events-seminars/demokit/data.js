let demokitVirtual1 = [
    ...
    {
        "URL": "B-4.html",
        "Image": "/fa/id_en/events-seminars/assets/img/showroom/B4/B4-1.png",
    ...
    {
        "URL": "NEW-B6.html",
        "Image": "/fa/id_en/events-seminars/assets/img/showroom/B6/B6-1.png",
...
$(document).ready(function () {
    ...
    if (virtualAttrQuery) {
        const url = `/fa/id_en/events-seminars/virtual-space/virtual-${virtualAttrQuery}.html`;
    ...
    $.each(data, function (_, item) {
        const html = `
                <div class="l-grid__item l-grid__item-3 l-grid__item-6-md l-grid__item-6-sm">
                    <a class="c-linkWithImage" href="/fa/id_en/events-seminars/demokit/${item.URL}?virtual=${selectedVirtual}">
