...
(function($) {
  ...
  $modalSelectProductsBody.load('/fa/id_id/download/assets/include/modal_select_products.html #contents');
  ...
  let targetLocation = '/fa/id_id/download/search.do';
  ...
  const _requestPage = function() {
    ...
    switch($downloadFilterActiveTab.attr('id').replace('tab_', '')) {
      ...
      case 'manual': 
        ...
        targetLocation = '/fa/id_id/download/search.do'; break;
      case 'technews':
        if(!currentKisyu) {
          locationSearchObject.mode = 'key' + locationSearchObject.mode;
          delete locationSearchObject['kisyu'];
        };
        targetLocation = '/fa/id_id/download/techinfo/search.do'; break;
      case 'cad':
        ...
        targetLocation = '/fa/id_id/download/cad/search.do'; break;
      case 'software': ;
      case 'lib':
        targetLocation = '/fa/id_id/download/software/search.do'; break;
    }
  ...
  const initEvent = function() {
    ...
    $('a[href*="/fa/id_id/download/cad/"], a[href*="/fa/id_id/download/software/"]').on('click.modal', function(e) {
      e.preventDefault();
      const $this = $(this);
      ...
      if(cookiesObject.fa_country_region) {
        ...
        $.ajax({
          url: '/fa/id_id/download/index.html',
          dataType: 'html'
        })
        .done(function(data) {
  ...
  if(currentKisyu) {
    ...
    modeArray.forEach(function(modeValue, index) {
      ...
      .fail(function(jqXHR, textStatus, errorThrown) {
        jsonRequestUrlObject[modeValue] = '/fa/id_id/download/data/noconditions.json';
      });
    });
