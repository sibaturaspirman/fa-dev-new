...
(function($) {
  ...
  $modalSelectProductsBody.load('/id_id/download/assets/include/modal_select_products.html #contents');
  ...
  let targetLocation = '/id_id/download/search.do';
  ...
  const _requestPage = function() {
    ...
    switch($downloadFilterActiveTab.attr('id').replace('tab_', '')) {
      ...
      case 'manual': 
        ...
        targetLocation = '/id_id/download/search.do'; break;
      case 'technews':
        if(!currentKisyu) {
          locationSearchObject.mode = 'key' + locationSearchObject.mode;
          delete locationSearchObject['kisyu'];
        };
        targetLocation = '/id_id/download/techinfo/search.do'; break;
      case 'cad':
        ...
        targetLocation = '/id_id/download/cad/search.do'; break;
      case 'software': ;
      case 'lib':
        targetLocation = '/id_id/download/software/search.do'; break;
    }
  ...
  if(currentKisyu) {
    ...
    modeArray.forEach(function(modeValue, index) {
      ...
      .fail(function(jqXHR, textStatus, errorThrown) {
        jsonRequestUrlObject[modeValue] = '/id_id/download/data/noconditions.json';
      });
    });
