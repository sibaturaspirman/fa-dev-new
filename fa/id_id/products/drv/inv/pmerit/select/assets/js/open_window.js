...
function MM_openBrWindow() {
    ...
    window.open("/id_id/products/drv/inv/pmerit/select/app/fan.html","popupr", IE_DEBUG_OPTION + "width=" + windowW + ",height=" + windowH + ",scrollbars=" + scroll);
}
...
function MM_openBrWindow02() {
    ...
    var IE_DEBUG_OPTION = (false ? "menubar=1,toolbar=1," : "");
    window.open("/id_id/products/selectiontool/common/index.html","popupr", IE_DEBUG_OPTION + "width=" + windowW + ",height=" + windowH + ",scrollbars=" + scroll);
