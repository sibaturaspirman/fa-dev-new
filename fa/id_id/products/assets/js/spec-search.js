...
if(isDotPage) {
	...
	function tablePicture(src) {
		...
		new_window.document.write("<img src=\"/id_id/shared/img/module/bt_close_bunrui.gif\" width=\"58\" height=\"18\" alt=\"" + specSearchLabels.close + "\" title=\"" + specSearchLabels.close + "\">\n");
		new_window.document.write("</div>");
