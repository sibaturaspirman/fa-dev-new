...
(function($) {
	...
	window.MEL_SETTINGS = $.extend(
		{
			...
			footer_container_path: '/fa/id_id/shared/gws0001/default/include/_footer.html',
			footer_simple_container_path: '/fa/id_id/shared/gws0001/default/include/_footer_simple.html',

			// Header
			header_path: '/fa/id_id/shared/gws0001/include/me_header.html',
			header_simple_path: '/fa/id_id/shared/gws0001/include/me_header_simple.html',

			// Footer
			footer_main_path: '/fa/id_id/shared/gws0001/include/me_footer.html',
			footer_popup_path: '/fa/id_id/shared/gws0001/include/me_footer_popup.html',
			footer_sns_path: '/fa/id_id/shared/gws0001/include/_footer_sns.html',
				...
				if(!jsonObject) {
					...
					if(jsonObject.child) {
						...
						return `
							...
							<div class="c-linkWithIcon__icon"><img src="/fa/id_id/shared/common/img/icon/icon_${jsonObject.icon}.svg" alt="" with="60" height="60" decoding="async"></div>
	...
	$(function() {
		...
		.done(function(directoriesJsonData, settingsJsonData) {
			...
			if(window.MEL_SETTINGS.current_path !== '/fa/id_id/about-us/automating-the-world/') {
							...
							"commonItems": [
								{
									"name": "Hubungi Kami",
									"icon": "contact",
									"link": "/fa/id_id/contact-us/index.html"
								},
								// {
								// 	"name": "Whatsapp",
								// 	"icon": "chat",
